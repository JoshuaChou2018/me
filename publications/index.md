...
1. <font color=#0096FF>Towards Trustworthy Dermatology MLLMs: A Benchmark and Multimodal Evaluator for Diagnostic Narratives  </font> <br><u>Yuhao Shen</u>, <u>Jiahe Qian</u>, <u>Zhangtianyi Chen</u>, **Juexiao Zhou***<br>

   ***Accepted***<br>

   ***ECCV 2026***

2. <font color=#0096FF>Adaptive feature unlearning for trustworthy medical imaging privacy.  </font><br>
...
3. <font color=#0096FF>Pushing the boundaries of autonomous biological discovery.  </font><br>
...
4. <font color=#0096FF>Large Language Models in Biomedicine and Healthcare.  </font><br>
...
5. <font color=#0096FF>Streamline Automated Biomedical Discoveries with Agentic Bioinformatics  </font> <br>
...
6. <font color=#0096FF>Evaluating and Mitigating Bias in AI-Driven Medical Text Generation.  </font><br>
...
7. <font color=#0096FF>Deep learning-driven pulmonary artery and vein segmentation reveals demography-associated vasculature anatomical differences. </font><br>
...
8. <font color=#0096FF>AggNet: Advancing Protein Aggregation Analysis Through Deep Learning and Protein Language Model.  </font><br>
...
9. <font color=#0096FF>Unveiling the Power of Language Models in Chemical Research Question Answering. </font><br>
...
10. <font color=#0096FF>An AI Agent for Fully Automated Multi-omic Analyses. </font>  
...
11. <font color=#0096FF>Pre-trained Multimodal Large Language Model Enhances Dermatological Diagnosis using SkinGPT-4. </font>  
...
12. <font color=#0096FF>HELM-GPT: de novo macrocyclic peptide design using generative pre-trained transformer. </font>  
...
13. <font color=#0096FF>KaryoXpert: An Accurate Chromosome Segmentation and Classification Framework for Karyotyping Analysis without Training with Manually Labeled Metaphase-Image Mask Annotations. </font>  
...
14. <font color=#0096FF>Patient privacy in AI-driven omics methods. </font>  
...
15. <font color=#0096FF>PPML-Omics: A privacy-preserving federated machine learning method protects patients’ privacy in omic data. </font>  
...
16. <font color=#0096FF>Personalized and privacy-preserving federated heterogeneous medical image analysis with PPPML-HMI. </font>  
...
17. <font color=#0096FF>Repetitive DNA sequence detection and its role in the human genome. </font>   
...
18. <font color=#0096FF>A unified method to revoke the private data of patients in intelligent healthcare with audit to forget. </font>   
...
19. <font color=#0096FF>Optimization of binding affinities in chemical space with generative pre-trained transformer and deep reinforcement learning.  </font>  
...
20. <font color=#0096FF>Predicting the antigenic evolution of SARS-COV-2 with deep learning.  </font>  
...
21. <font color=#0096FF>AB-Gen: Antibody Library Design with Generative Pre-trained Transformer and Deep Reinforcement Learning. </font>   
...
22. <font color=#0096FF>A comprehensive benchmarking with practical guidelines for cellular deconvolution of spatial transcriptomics.  </font>  
...
23. <font color=#0096FF>Accurate transcriptome-wide identification and quantification of alternative polyadenylation from RNA-seq data with APAIQ.  </font>  
...
24. <font color=#0096FF>Applications of Deep Learning in Understanding Gene Regulation.  </font>  
...
25. <font color=#0096FF>Annotating TSSs in Multiple Cell Types Based on DNA Sequences and RNA-seq Data via DeeReCT-TSS.  </font>  
...
26. <font color=#0096FF>SD2: Spatially resolved transcriptomics deconvolution through integration of spatial and dropout information. </font>   
...
27. <font color=#0096FF>An Interpretable Deep Learning Workflow for Discovering Sub-Visual Abnormalities in CT Scans of COVID-19 Inpatients and Survivors.   </font>  
...
28. <font color=#0096FF>An interpretable computer-aided diagnosis method for periodontitis from panoramic radiographs.  </font>  
...
29. <font color=#0096FF>DeeReCT-APA: Prediction of Alternative Polyadenylation Site Usage through Deep Learning.  </font>  
...
30. <font color=#0096FF>A Rapid, Accurate and Machine-agnostic Segmentation and Quantification Method for CT-based COVID-19 Diagnosis.  </font>  
...
31. <font color=#0096FF>Automatic and interpretable model for periodontitis diagnosis in panoramic radiographs.  </font>  
      Haoyang Li, **Juexiao Zhou**, Yi Zhou, Jieyu Chen, Feng Gao, Ying Xu, Xin Gao*.   
...
32. <font color=#0096FF>CaMeRe: A novel tool for inference of cancer metabolic reprogramming. </font>  
...
33. <font color=#0096FF>Pan-tissue analysis of allelic alternative polyadenylation suggests widespread functional regulation. </font>  
...
34. <font color=#0096FF>Global burden of 292 causes of death in 204 countries and territories and 660 subnational locations, 1990–2023: a systematic analysis for the Global Burden of Disease Study 2023. </font>      
...
35. <font color=#0096FF>Burden of 375 diseases and injuries, risk-attributable burden of 88 risk factors, and healthy life expectancy in 204 countries and territories, including 660 subnational locations, 1990–2023: a systematic analysis for the Global Burden of Disease Study 2023. </font>      
...
36. <font color=#0096FF>Global age-sex-specific all-cause mortality and life expectancy estimates for 204 countries and territories and 660 subnational locations, 1950–2023: a demographic analysis for the Global Burden of Disease Study 2023. </font>      
...
37. <font color=#0096FF>The global, regional, and national burden of cancer, 1990–2023, with forecasts to 2050: a systematic analysis for the Global Burden of Disease Study 2023. </font>      
...
38. <font color=#0096FF>Global, regional, and national burden of upper respiratory infections and otitis media, 1990–2021: a systematic analysis from the Global Burden of Disease Study 2021. </font>      
...
39. <font color=#0096FF>Burden of disease scenarios for 204 countries and territories, 2022–2050: a forecasting analysis for the Global Burden of Disease Study 2021. </font>  
...
40. <font color=#0096FF>Global burden and strength of evidence for 88 risk factors in 204 countries and 811 subnational locations, 1990–2021: a systematic analysis for the Global Burden of Disease Study 2021. </font>  
...
41. <font color=#0096FF>Global incidence, prevalence, years lived with disability (YLDs), disability-adjusted life-years (DALYs), and healthy life expectancy (HALE) for 371 diseases and injuries in 204 countries and territories and 811 subnational locations, 1990–2021: a systematic analysis for the Global Burden of Disease Study 2021.</font>   
...
42. <font color=#0096FF>Global burden of 288 causes of death and life expectancy decomposition in 204 countries and territories and 811 subnational locations, 1990–2021: a systematic analysis for the Global Burden of Disease Study 2021. </font>  
...
43. <font color=#0096FF>Global fertility in 204 countries and territories, 1950–2021, with forecasts to 2100: a comprehensive demographic analysis for the Global Burden of Disease Study 2021. </font>  
...
44. <font color=#0096FF>Global age-sex-specific mortality, life expectancy, and population estimates in 204 countries and territories and 811 subnational locations, 1950–2021, and the impact of the COVID-19 pandemic: a comprehensive demographic analysis for the Global Burden of Disease Study 2021.</font>  
